...
class ServiceDetailScreen extends BaseRoute {
  ...
  const ServiceDetailScreen(
      {super.key, super.a, super.o, this.serviceName, this.serviceImage})
      : super(r: 'ServiceDetailScreen');
  @override
  BaseRouteState<ServiceDetailScreen> createState() =>
...
class _ServiceDetailScreenState extends BaseRouteState<ServiceDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
          ...
          bottomNavigationBar: _barberShopList!.isNotEmpty &&
  ...
  _getSalonListForServices() async {
    try {
      ...
      debugPrint(
          "Exception - service_detail_screen.dart - _getSalonListForServices():$e");
    }
  }
