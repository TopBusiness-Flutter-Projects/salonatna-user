...
//   //     'amount': widget.screenId == 1
//   //         ? widget.bookNowDetails!.remPrice
//   //         : widget.cartList!.totalPrice,
//   //     'name': widget.screenId == 1
//   //         ? widget.bookNowDetails!.cartId
//   //         : widget.cartList!.cartItems[0].orderCartId,
//   //     'prefill': {
//   //       'contact': global.user!.userPhone,
...
//   //     payPlugin
//   //         .initialize(
//   //             publicKey: _paymentGatewayList!.paystack!.payStackPublicKey!)
//   //         .then((value) {
...
//                       MaterialPageRoute(builder: (context) => PaymentWebViewScreen(a: widget.analytics, o: widget.observer, orderId: r.orderId??0,
//                       url: r.paymentUrl,)));
//                   }
...
//           } else {
//             await apiHelper!
//                 .productCartCheckout(global.user!.id, "success", "paymob",
//                    )
//                 .then((result) {
//               if (result != null) {
//                 if (result.status == "1") {
...
//             success: true);
//       } catch (e) {
//         debugPrint("Exception - payment_gateways_screen.dart - payWithNewCard(): $e");
//         hideLoader();
...
//   //   } catch (e) {
//   //     debugPrint(
//   //         "Exception - payment_gateways_screen.dart - _chargeCard(): $e");
//   //   }
//   // }
...
//   //   } catch (e) {
//   //     debugPrint(
//   //         "Exception - payment_gateways_screen.dart.dart - _getPaymentGateways():$e");
//   //   }
//   // }
...
//   //   } catch (e) {
//   //     debugPrint(
//   //         "Exception - payment_gateways_screen.dart -  _handlePaymentError$e");
//   //   }
//   // }
...
//   //   } catch (e) {
//   //     debugPrint(
//   //         "Exception - payment_gateways_screen.dart - _handlePaymentSuccess$e");
//   //   }
//   // }
...
//   //           if (widget.screenId == 1) {
//   //             callId == 1
//   //                 ? payStatck(_paymentGatewayList!.paystack!.payStackSecretKey)
//   //                 : await payWithNewCard(
//   //                     card: stripeCard,
//   //                     amount: widget.bookNowDetails!.remPrice,
...
//   //                 : await payWithNewCard(
//   //                     card: stripeCard,
//   //                     amount: widget.cartList!.totalPrice.toString(),
//   //                     currency: global.currency.currency);
//   //           }
...
//   //   } catch (e) {
//   //     debugPrint(
//   //         "Exception - payment_gateways_screen.dart - _startAfreshCharge(): $e");
//   //   }
//   // }
...
//   //   } catch (e) {
//   //     debugPrint(
//   //         'Exception - payment_gateways_screen.dart - exitAppDialog(): $e');
//   //   }
//   // }
