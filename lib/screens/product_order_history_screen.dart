...
class ProductOrderHistoryScreen extends BaseRoute {
  const ProductOrderHistoryScreen({super.key, super.a, super.o}) : super(r: 'ProductOrderHistoryScreen');

  @override
  BaseRouteState<ProductOrderHistoryScreen> createState() => _ProductOrderHistoryScreenState();
}

class _ProductOrderHistoryScreenState extends BaseRouteState<ProductOrderHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
          appBar: AppBar(
            title: RichText(
              text: TextSpan(text: AppLocalizations.of(context)!.lbl_my_orders, style: Theme.of(context).appBarTheme.titleTextStyle, children: [TextSpan(text: AppLocalizations.of(context)!.txt_store_pick_up_only, style: Theme.of(context).primaryTextTheme.titleMedium)]),
            ),
          ),
          body: _isDataLoaded
              ? _productOrderHistoryList != null && _productOrderHistoryList!.isNotEmpty
                  ? ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          ...
                          child: Card(
                              ...
                              child: ListTile(
                                title: Text('${_productOrderHistoryList![index].cartId}', style: Theme.of(context).primaryTextTheme.titleSmall),
                                subtitle: Padding(
                                  ...
                                  children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Center(
                                              child: Text(
                                                _productOrderHistoryList![index].status == 4
                                    ...
                                    Padding(
                                      ...
                                      child: SizedBox(
                                        width: 80,
                                        child: Column(
                                          crossAxisAlignment: global.isRTL ? CrossAxisAlignment.end : CrossAxisAlignment.end,
                                          children: [
                                            SizedBox(
                                              height: 15,
                                              child: Text(
                                                DateFormat('hh:mm a').format(_productOrderHistoryList![index].createdAt!),
                                            ...
                                            SizedBox(
                                              height: 15,
                                              child: Text(
                                                DateFormat('dd/MM/yyyy').format(_productOrderHistoryList![index].createdAt!),
                                                textAlign: TextAlign.right,
                                                style: Theme.of(context).primaryTextTheme.bodyMedium,
                                              ),
                                            ),
  ...
  _getProductOrderHistory() async {
    try {
      ...
      debugPrint("Exception - product_order_history_screen.dart - _getProductOrderHistory():$e");
    }
  }
